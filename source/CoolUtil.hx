...
class CoolUtil
{
	...
	public static function sendtodiscord(songname:String = 'ERROR', storymode:Bool = false) {
		var message = '';
		if(storymode) {
			message = 'GUYS SOMEONE BEAT THE ' + songname + ' WEEK IN BRUTAL'; 
		} else {
			message = 'GUYS SOMEONE BEAT ' + songname + ' IN BRUTAL'; 
		}
